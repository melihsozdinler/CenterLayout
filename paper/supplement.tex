...
\begin{figure}[h]
  ...
  \caption{Grouped. Modules on a ring with members packed inside each. On a PPI network
  this is honest only when the network has more than one component --- see
  \S\ref{sec:modules}, which is what to use instead.}
\end{figure}
