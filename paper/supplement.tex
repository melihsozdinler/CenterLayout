...
\input{supplement/tables.tex}

\title{ProLiVis 2.0 --- Supplementary Material\\[2pt]
\large A walkthrough of every capability}
% The paper's authors and affiliations, in article-class form: IEEEtran's author
% macros do not exist here. Turkish letters as LaTeX accents, as in the paper.
\author{%
  % One line, spaced with \quad: \and set each name in its own column, which put three
  % on one line and the fourth alone below.
  Melih Sözdinler\textsuperscript{1,2} \quad
  Yalç\i{}n Doksanbir\textsuperscript{1} \quad
  Gökhan Akp\i{}nar\textsuperscript{1} \quad
  Ege Aktan\textsuperscript{1}\\[6pt]
  {\small\textsuperscript{1}Emlakjet, R\&D Center, R\&D, 34764 \.{I}stanbul, Turkey}\\
  {\small\textsuperscript{2}Computer Engineering, Faculty of Engineering and Natural Sciences,}\\
  {\small I\c{s}\i{}k University, 34980 \.{I}stanbul, Turkey}\\[4pt]
  % Two lines: a typewriter address never breaks, and four on one line overran the
  % margin by 120pt.
  {\small\texttt{melih.sozdinler@emlakjet.com}, \texttt{yalcin.doksanbir@emlakjet.com},}\\
  {\small\texttt{gokhan.akpinar@emlakjet.com}, \texttt{ege.aktan@emlakjet.com}}\\[2pt]
  {\small Corresponding author: Melih Sözdinler}}
\date{}
